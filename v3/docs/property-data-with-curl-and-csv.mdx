...
```curl
curl --user AAAXXXXXXXXXXXX: 'https://api.documentationai.com/v3/data/properties?view=properties_all&format=JSON&q=country:US&records=1&download=false'
```
...
Each property record will have multiple fields associated with it.  You can see a full list of available fields in our [Property Data Schema](https://java.documentationai.com/v3/docs/property-data-schema).
...
`https://AAAXXXXXXXXXXXX:@api.documentationai.com/v3/data/properties?view=properties_all&format=JSON&q=country:US+AND+propertyType:"Single+Family+Dwelling"&records=10&download=false`
...
```curl
curl --user AAAXXXXXXXXXXXX: 'https://api.documentationai.com/v3/data/properties?view=properties_all&format=JSON&q=q=country:US+AND+propertyType:"Single+Family Dwelling"&records=10&download=false'
```
...
`https://AAAXXXXXXXXXXXX:@api.documentationai.com/v3/data/properties?view=properties_all_nested&format=CSV&q=country:US+AND+propertyType:"Single+Family+Dwelling"&download=true`

When you make this API call, you'll see a response similar to:

```curl
curl --user AAAXXXXXXXXXXXX: 'https://api.documentationai.com/v3/data/properties?view=properties_all_nested&format=CSV&q=country:US+AND+propertyType:"Single+Family+Dwelling"&download=true'
```
...
<Image src="https://files.readme.io/bef2b56-property_sample.jpg" width="1920" height="1080" alt="property_sample.jpg" />
