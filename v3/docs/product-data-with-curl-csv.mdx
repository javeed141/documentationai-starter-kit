...
```curl
curl --user AAAXXXXXXXXXXXX: 'https://api.documentationai.com/v3/data/products?view=products_all&format=CSV&q=categories:shoes+AND+-categories:shirts+AND+categories:women+AND+%28brand%3A%2A+OR+manufacturer%3A%2A%29+AND+prices%3A%2A&download=true'
```
...
<Image src="https://files.readme.io/7938051-shoe_sample.jpg" width="1920" height="1080" alt="shoe_sample.jpg" />
