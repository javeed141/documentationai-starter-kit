...
```curl
curl --user AAAXXXXXXXXXXXX: 'https://api.documentationai.com/v3/data/businesses?view=businesses_all_nested&format=CSV&q=categories:hotels+AND+country:US&download=true'
```
...
<Image src="https://files.readme.io/eeb2bad-hotel_sample.jpg" width="1920" height="1080" alt="hotel_sample.jpg" />
