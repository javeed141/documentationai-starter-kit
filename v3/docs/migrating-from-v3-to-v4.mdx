...
<Image src="https://files.readme.io/0f7198e-auth_v3.jpg" width="1920" height="1080" alt="auth v3.jpg" />

Here's the same request in the V4 API:

<Image src="https://files.readme.io/6860a81-auth_v4.jpg" width="1920" height="1080" alt="auth v4.jpg" />
...
* [Getting started with Business Data](https://developer.documentationai.com/v4/docs/getting-started-with-business-data)
* [Getting started with Product Data](https://developer.documentationai.com/v4/docs/getting-started-with-property-data)
* [Getting started with Property Data](https://developer.documentationai.com/v4/docs/getting-started-with-product-data)
...
As a reminder, views specify which fields are returned in your search or download request and how those fields are formatted.  For example, the [products_basicFields](https://developer.documentationai.com/v3/docs/products_basicfields) view for product data only returns a subset of available product fields, while the [products_pricesFlat](https://developer.documentationai.com/v3/docs/products_pricesflat) view will split multiple prices for a single product into different rows when requesting CSV data.
...
* [Creating your own view](https://developer.documentationai.com/v4/reference#create-view)
