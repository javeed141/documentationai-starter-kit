...
`https://AAAXXXXXXXXXXXX:@api.documentationai.com/v3/data/products?view=products_all&format=CSV&q=categories:shoes AND -categories:shirts AND categories:women AND (brand:* OR manufacturer:*) AND prices:*&download=true`
