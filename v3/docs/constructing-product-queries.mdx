...
You can do similar queries on any of the fields in the [product schema](https://java.documentationai.com/v3/docs/product-data-schema).  Here's an example that queries the `name` field:
