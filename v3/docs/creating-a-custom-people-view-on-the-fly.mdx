...
This method will create a permanent view that you can declare by name in the view of your search body. Using the [https://api.documentationai.com/v4/views](https://api.documentationai.com/v4/views) API endpoint you can create a view. We will use the previous fields as our view body. We will name this view `people_simplified`.
