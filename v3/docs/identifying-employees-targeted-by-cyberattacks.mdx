...
<Image src="https://files.readme.io/b5f3273-image.png" width="1920" height="1080" alt="" />
...
For anything searching a large amount of people data, we recommend automating this with our Datafiniti People API Search. For more on that you can read more here: [People Use Cases](https://java.documentationai.com/docs/people-use-cases)
</Callout>
