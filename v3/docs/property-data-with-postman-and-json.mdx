...
`https://AAAXXXXXXXXXXXX:@api.documentationai.com/v3/data/properties?view=properties_all&format=JSON&q=country:US AND categories:"Single Family Dwelling"&download=true`
