...
`https://AAAXXXXXXXXXXXX:@api.documentationai.com/v3/data/properties?view=properties_all&format=JSON&q=country:US&records=1&download=false`
...
`https://AAAXXXXXXXXXXXX:@api.documentationai.com/v3/data/properties?view=properties_all&format=JSON&q=country:US AND propertyType:"Single Family Dwelling"&download=true`
