...
* [properties_all](https://java.documentationai.com/v3/docs/properties_all)
* [properties_all_nested](https://java.documentationai.com/v3/docs/properties_all_nested)
