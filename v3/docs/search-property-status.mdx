...
We recommend users view our possible status type values page [here ](https://developer.documentationai.com/docs/possible-values-for-property-fields)to determine the exact string to search property data for.
</Callout>
