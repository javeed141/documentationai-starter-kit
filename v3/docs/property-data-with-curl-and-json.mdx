...
```curl
curl --user AAAXXXXXXXXXXXX: 'https://api.documentationai.com/v3/data/properties?view=properties_all&format=JSON&q=country:US+AND+propertyType:"Single+Family+Dwelling"&download=true'
```
...
From here, you'll most likely want to process the data using the programming language of your choice. Our other [JSON guides](https://java.documentationai.com/v3/docs/getting-started-with-property-data) provide instructions on how to process this data.
