...
You can do similar queries on any of the fields in the [people schema](https://java.documentationai.com/docs/people-data-schema).  Here's an example that queries the `businessName` field:
