...
* [Product Data Schema](https://java.documentationai.com/docs/product-data-schema)

We will use the [https://api.documentationai.com/v4/views](https://api.documentationai.com/v4/views) API endpoint to create this view. We will use the following top level product fields to create a view that only provides these fields upon an API search/enrichment/suppression request.
