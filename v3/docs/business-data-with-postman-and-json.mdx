...
`https://AAAXXXXXXXXXXXX:@api.documentationai.com/v3/data/businesses?view=businesses_all&format=JSON&q=categories:hotels&records=1&download=false`
...
`https://AAAXXXXXXXXXXXX:@api.documentationai.com/v3/data/businesses?view=businesses_all_nested&format=CSV&q=categories:hotels AND country:US&download=true`
