...
<Image src="https://files.readme.io/1fcfd13-fileJSONselect.png" width="1920" height="1080" alt="fileJSONselect.png" />
...
You can read more about other property schema fields [here](https://developer.documentationai.com/docs/property-data-schema).

<Image src="https://files.readme.io/3c8131c-PropertyEnrichParamsJson.gif" width="1920" height="1080" alt="PropertyEnrichParamsJson.gif" />

<Callout kind="alert">
  **JSON format**

Our enrichment search API will not allow any JSON object with keys that do not match your field parameters. Be sure to match the field parameter in our property schema [here](https://developer.documentationai.com/docs/property-data-schema). A common error you may see in this case: 
...
<Image src="https://files.readme.io/7000e4e-enrichpropertiesjsonQuery.png" width="1920" height="1080" alt="enrichpropertiesjsonQuery.png" />
...
Finally, the view is used to specify which fields you want to be added to your data. If no view is provided, we will add all fields from matching records as we do for our ***default*** view for the [Available Views for Property Data](https://java.documentationai.com/docs/available-views-for-property-data)

Your final parameter should be set up as the following.

<Image src="https://files.readme.io/4d2bb9a-JsonEnrichment.png" width="1920" height="1080" alt="JsonEnrichment.png" />

Listed below is a cURL POST to import this example into Postman.

```curl
curl --location 'https://api.documentationai.com/v4/properties/search/enrichment' \
