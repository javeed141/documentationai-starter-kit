...
This method will create a permanent view that you can declare by name in the view of your search body. Using the [https://api.documentationai.com/v4/views](https://api.documentationai.com/v4/views) API endpoint you can create a view. We will use the previous fields as our view body. We will name this view `custom_transaction_view`.
...
Please note you can name the view any string value not currently used. To check your current view you can use: [https://api.documentationai.com/v4/views?page=1&limit=10](https://api.documentationai.com/v4/views?page=1&limit=10)
</Callout>

<Callout kind="alert">
  **dataType**

Be sure that you declare the correct dataType to the dataType you wish to search. As we need to match the API to the dataType's schema. Learn more about [Property Data Schema](https://java.documentationai.com/docs/property-data-schema).
</Callout>
