...
From here, you'll most likely want to process the data using the programming language of your choice. Our other [JSON guides](https://java.documentationai.com/docs/getting-started-with-business-data) provide instructions on how to process this data.
