...
```curl
curl --user AAAXXXXXXXXXXXX: 'https://api.documentationai.com/v3/data/businesses?view=businesses_all&format=JSON&q=categories:hotels&records=1&download=false'
```
...
Each business record will have multiple fields associated with it.  You can see a full list of available fields in our [Business Data Schema](https://java.documentationai.com/v3/docs/business-data-schema).
...
`https://AAAXXXXXXXXXXXX:@api.documentationai.com/v3/data/businesses?view=businesses_all&format=JSON&q=categories:hotels AND country:US&records=10&download=false`
...
```curl
curl --user AAAXXXXXXXXXXXX: 'https://api.documentationai.com/v3/data/businesses?view=businesses_all&format=JSON&q=categories:hotels+AND+country:US&records=10&download=false'
```
...
```curl
curl --user AAAXXXXXXXXXXXX: 'https://api.documentationai.com/v3/data/businesses?view=businesses_all&format=JSON&q=categories:hotels+AND+country:US&download=true'
```
...
From here, you'll most likely want to process the data using the programming language of your choice. Our other [JSON guides](https://java.documentationai.com/v3/docs/getting-started-with-business-data) provide instructions on how to process this data.
