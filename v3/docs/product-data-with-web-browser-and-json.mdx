...
`https://AAAXXXXXXXXXXXX:@api.documentationai.com/v3/data/products?view=products_all&format=JSON&q=categories:shoes&records=1&download=false`
...
`https://AAAXXXXXXXXXXXX:@api.documentationai.com/v3/data/products?view=products_all&format=JSON&q=categories:shoes AND -categories:shirts AND categories:women AND (brand:* OR manufacturer:*) AND prices:*&download=true`
...
`https://AAAXXXXXXXXXXXX:@api.documentationai.com/v3/results/XXXX`
