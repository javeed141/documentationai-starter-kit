...
```curl
curl --request POST --url https://api.documentationai.com/v4/properties/search --header 'authorization: Bearer AAAXXXXXXXXXXXX' --data '{"query":"country:US","num_records":1}'
```
...
Each property record will have multiple fields associated with it.  You can see a full list of available fields in our [Property Data Schema](https://java.documentationai.com/docs/property-data-schema).
...
```curl
curl --request POST --url https://api.documentationai.com/v4/businesses/search --header 'authorization: Bearer AAAXXXXXXXXXXXX' --data '{"query":"country:US AND propertyType:\"Single Family Dwelling\"","format":"json","num_records": 10}'
```
...
```curl
curl --request POST --url https://api.documentationai.com/v4/businesses/search --header 'authorization: Bearer AAAXXXXXXXXXXXX' --data '{"query":"country:US AND propertyType:\"Single Family Dwelling\"", "num_records": 50,"format":"json", "download": true}'
```
...
```curl
curl --request GET --url https://api.documentationai.com/v4/downloads/XXXX --header 'authorization: Bearer AAAXXXXXXXXXXXX'
```
...
Navigate to the results file URL or you download page [here](https://portal.documentationai.com/download) and open the file(s) pertaining to your download ID.
...
From here, you'll most likely want to process the data using the programming language of your choice. Our other [Getting Started with Property Data](https://java.documentationai.com/docs/getting-started-with-property-data) provide instructions on how to process this data.
...
For more use case specific examples please visit our [Use Cases for Property Data](https://java.documentationai.com/docs/use-cases-for-property-data).
...
From here, you'll most likely want to process the data using the programming language of your choice. Our other [JSON guides](https://java.documentationai.com/docs/getting-started-with-property-data) provide instructions on how to process this data.
