...
The pagination endpoint is very similar to the [search endpoint](https://java.documentationai.com/docs/property-data-with-curl#3-run-your-first-search).  Here's an example request:
...
* [How Credits Work](https://java.documentationai.com/docs/how-credits-work-1)
