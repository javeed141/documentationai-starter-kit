...
APICall = 'https://' + APIToken + ':@api.documentationai.com/v3/data/properties?' \
			+ 'view=' + view \
			+ '&format=' + format \
			+ '&q=' + query \
			+ '&records=' + records \
...
if r.status_code == 200:
	...
	if requestResponseStatus == 'COMPLETED':
		result = requests.get('https://' + APIToken + ':@api.documentationai.com/v3/results/' + str(requestID))
...
<Image src="https://files.readme.io/4bc9ef6-property_sample.jpg" width="1920" height="1080" alt="property_sample.jpg" />
