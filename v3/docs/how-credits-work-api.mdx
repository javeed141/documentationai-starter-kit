...
GET [https://api.documentationai.com/v4/account](https://api.documentationai.com/v4/account)
...
However if you have a custom plan or need help figuring out your data plan please contact [billing@documentationai.com](mailto:billing@documentationai.com)

## Find your credits used

You can also use your GET [https://api.documentationai.com/v4/account](https://api.documentationai.com/v4/account) to check your credits used of your account.\
...
POST [https://api.documentationai.com/v4/properties/search](https://api.documentationai.com/v4/properties/search)
...
Whether it be via postman, our [Property Data](https://java.documentationai.com/reference/properties) reference page, or any other coding language, you will receive a 400 error message when your credit limit will be reached. The error message will look like this.
...
If you plan to exceed your credit limit, please contact your Datafiniti customer success representative for refreshing or upgrade your accounts credit limit. Contact us at [support@documentationai.com](mailto:support@documentationai.com) to find this info out.
</Callout>

## Credit limit refresh period

Your credits to your Datafiniti account refresh period is based on of your data plan subscription. This can vary from monthly to annually. For standard tier plans you can check your settings page [here](https://portal.documentationai.com/settings). Please consult with your Datafiniti representative if you do not know your plan's refresh rate.
