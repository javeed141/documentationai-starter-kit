...
You can do similar queries on any of the fields in the [property schema](https://java.documentationai.com/docs/property-data-schema).  Here's an example that queries the `propertyType` field:
