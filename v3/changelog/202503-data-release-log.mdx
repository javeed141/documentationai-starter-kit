---
title: 2025.03 - Data Release Log
---
...
We're revamping our [www.documentationai.com](http://www.documentationai.com) landing page to improve navigation, usability, and showcase how our data empowers businesses. Stay tuned for the launch of our fresh, user-friendly design!

## Improved Autotrace Property Data

We're working on a powerful new feature for property data searches. The auto_trace parameter will allow you to combine data from both people and property datasets in a single API call. This enhancement will:
