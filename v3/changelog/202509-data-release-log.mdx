---
title: 2025.09 - Data Release Log
---
...
| :--- |
| brandTenant   <br/> brokerCoop   <br/> buildingClass   <br/> dateOnMarket   <br/> daysOnMarket   <br/> effectiveGrossIncome   <br/> grossRentalIncome   <br/> groundLease   <br/> investmentSubtype   <br/> investmentType   <br/> leaseType   <br/> majorTenants   <br/> netRentable   <br/> netOperatingIncome   <br/> numBuildings   <br/> numProperties   <br/> numTenants   <br/> occupancy   <br/> operatingExpenses   <br/> otherIncome   <br/> ownership   <br/> proFormaNOI   <br/> rentableSquareFeet   <br/> rentBumps   <br/> saleCondition   <br/> saleType   <br/> sourceURLsPerField   <br/> subtype   <br/> tenancy   <br/> tenantCredit   <br/> totalExpenses   <br/> vacancyLoss   <br/> virtualTour   <br/> yearRenovated |
