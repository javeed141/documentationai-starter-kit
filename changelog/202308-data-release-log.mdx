---
title: 2023.08 - Data Release Log
---
...
* New property data sub field in brokers [Property Data Schema](https://java.documentationai.com/docs/property-data-schema)
...
* New people data schema fields [People Data Schema](https://java.documentationai.com/docs/people-data-schema)
  * Industries
  * Licenses
    * type
    * value
