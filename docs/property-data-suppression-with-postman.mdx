...
Next, we will open the Datafiniti api library in Postman. For how to get the Postman library, you can use this guide here: [Postman Guide](https://support.documentationai.com/docs/postman-endpoint-overview) Once open we will use the following query to look for `single family dwelling` in Austin Texas, US.
...
<Image src="https://files.readme.io/61513ca-image.png" width="1920" height="1080" alt="Postman suppression API call setup" />
...
You can check your download status by the following guide here: [Postman: Download Result Files](https://java.documentationai.com/docs/postman-downloading-result-files)
