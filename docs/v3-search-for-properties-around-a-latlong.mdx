...
This will narrow down your matches to properties that are single family homes or apartments.  You can add any additional filters from the fields [available in our schema](https://developer.documentationai.com/docs/property-data-schema).
