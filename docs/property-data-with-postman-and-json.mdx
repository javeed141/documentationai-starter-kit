...
<Image src="https://files.readme.io/5d81381-fileJSONselect.png" width="1920" height="1080" alt="fileJSONselect.png" />
...
<Image src="https://files.readme.io/9fd4125-gtinsfieldparam.gif" width="1920" height="1080" alt="gtinsfieldparam.gif" />
...
<Image src="https://files.readme.io/002cb19-5d63a65-postmanProductEnrich.png" width="1920" height="1080" alt="5d63a65-postmanProductEnrich.png" />
...
Finally the view is used to specify which fields you want added to your data. If no view is provided, we will add all fields from matching records as we do for our ***default*** view for the [product search API](https://developer.documentationai.com/docs/available-views-for-product-data).

Your finally parameter should be setup as the following.

<Image src="https://files.readme.io/5d63a65-postmanProductEnrich.png" width="1920" height="1080" alt="postmanProductEnrich.png" />

Listed below is a cURL POST to import this example into Postman.

```bash
curl --location --request POST 'https://api.documentationai.com/v4/product/search/enrichment' \
