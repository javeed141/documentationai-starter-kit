...
You can add additional filters, as long as they reference valid [property data schema fields](https://java.documentationai.com/docs/property-data-schema). For instance, you might want to only download record that fit a particular price range or current status. You can filter by `mostRecentStatus` or by `mostRecentSaleListPriceAmount`.
...
<Image src="https://files.readme.io/3dbcd1294d4b5dabf360c5d5a399cae34acf633aa217d354dbbd6b3f8d0e815d-image.png" width="1920" height="1080" alt="" />
