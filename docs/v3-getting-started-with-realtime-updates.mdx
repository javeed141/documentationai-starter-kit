...
`POST https://api.documentationai.com/v4/targeted-updates`
...
`GET https://api.documentationai.com/v4/targeted-updates/<RU_ID>`
...
`GET https://api.documentationai.com/v4/targeted-updates/`
...
Please reach out to support@documentationai.com and send us your query parameters. There are many reasons why we may not update a specific set of records and we are here to help provide the highest quality to all data types.
</Callout>
