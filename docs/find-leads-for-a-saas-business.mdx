...
This will generate a CSV file with each field in our [people data schema](https://developer.documentationai.com/docs/people-data-schema) in a separate column.
