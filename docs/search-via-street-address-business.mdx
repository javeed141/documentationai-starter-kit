...
Since street addresses can be broken down into many parts, we will query based on each individual part. You can determine your fields to search via our [Business Data Schema](https://java.documentationai.com/docs/business-data-schema). We will query based on each part at the following address:
...
Datafiniti runs an address normalization process across our entire business and business database. We normalize our addresses to a 2-character abbreviation USPS standard. You can find out more about this process [Normalized Property Addresses](https://java.documentationai.com/docs/normalized-address-data).
</Callout>
...
You can always add any field search from our business [schema](https://java.documentationai.com/docs/possible-values-for-people-fields).
