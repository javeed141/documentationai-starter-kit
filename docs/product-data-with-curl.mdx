...
```curl
curl --request POST --url https://api.documentationai.com/v4/products/search --header 'authorization: Bearer AAAXXXXXXXXXXXX' --data '{"query":"categories:shoes","format:json","num_records":1}'
```
...
```curl
curl --request POST --url https://api.documentationai.com/v4/products/search --header 'authorization: Bearer AAAXXXXXXXXXXXX' --data '{"query":"categories:shoes AND -categories:shirts AND categories:women AND (brand:* OR manufacturer:*) AND prices:*","format:json","num_records": 10}'
```
...
```curl
curl --request POST --url https://api.documentationai.com/v4/products/search --header 'authorization: Bearer AAAXXXXXXXXXXXX' --data '{"query":"names:\"Apple Iphone 10\"", "num_records": 10}'
```
...
```curl
curl --request POST --url https://api.documentationai.com/v4/products/search --header 'authorization: Bearer AAAXXXXXXXXXXXX' --data '{"query":"categories:shoes AND -categories:shirts AND categories:women AND (brand:* OR manufacturer:*) AND prices:*","format:csv","num_records": 50, "download": true}'
```
