...
```php
<?php
$url = 'https://api.documentationai.com/v4/properties/search';
...
Each business record will have multiple fields associated with it.  You can see a full list of available fields in our [Property Data Schema](https://java.documentationai.com/docs/property-data-schema).
...
You can track the status of your download via the following method using our GET [https://api.documentationai.com/v4/downloads/:id](https://api.documentationai.com/v4/downloads/:id) endpoint
