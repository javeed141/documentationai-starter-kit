...
There are several fields in our property data schema you can utilize to search for refinanced property data. All of these fields can be found in our [Property Data Schema](https://java.documentationai.com/docs/property-data-schema). In this guide we will highlight using the following fields:
...
You can utilize the transactions field for more than just refiance data. Owner / seller data of the property can be had. Read [Find property comps from transaction data](https://java.documentationai.com/docs/find-property-comps-from-transaction-data) for more on using the `transactions` field.
</Callout>
