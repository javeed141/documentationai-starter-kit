...
<Image src="https://files.readme.io/9946bea-PostmanSearch.PNG" width="407" height="336" alt="Postman search endpoint configuration" />
...
<Image src="https://files.readme.io/b43812d-APIbasicSetup2.PNG" width="1630" height="570" alt="API basic setup showing multipart form data configuration" />
...
Since Enrichment charges credit per the batch file you are enriching data from, you may be overcharged credits to your account upon submitting an enrichment request. If you do not know if overcharging is enabled/disabled on your account you may contact support@datafiniti.co to find this info out.
</Callout>
