...
Shown here is a sample of the transaction data to expect. To learn more please read the transaction field of [Property Data Schema](https://java.documentationai.com/docs/property-data-schema)
...
Let's add a filter for a single family home. For more information on the possible `propertyTypes `you can visit here [Possible Values for Property Fields](https://java.documentationai.com/docs/possible-values-for-property-fields)
