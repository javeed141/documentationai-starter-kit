...
<Image src="https://files.readme.io/bdc1f80-enrichmentcsvFieldParams.gif" width="1920" height="1080" alt="Setting enrichment CSV field parameters" />
...
<Image src="https://files.readme.io/292c6b1-enrichpropertiesquery.png" width="1920" height="1080" alt="Property enrichment query configuration" />
...
Finally the view is used to specify which fields you want added to your data. If no view is provided, we will add all fields from matching records as we do for our ***default*** view for the [Available Views for Property Data](https://java.documentationai.com/docs/available-views-for-property-data)

Your finally parameter should be setup as the following.

<Image src="https://files.readme.io/0ac0eaf-enrichpropertiesformat.png" width="1920" height="1080" alt="Property enrichment format and view configuration" />
