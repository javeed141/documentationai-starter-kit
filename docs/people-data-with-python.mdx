...
# Make the API call.
r = requests.post('https://api.documentationai.com/v4/people/search',json=request_data,headers=request_headers);
...
<Image src="https://files.readme.io/5c1900e-people.png" width="1920" height="1080" alt="" />
