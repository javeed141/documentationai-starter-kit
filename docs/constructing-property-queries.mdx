...
You can do similar queries on any of the fields in the [property schema](https://java.documentationai.com/docs/property-data-schema).  Here's an example that queries the `country` field:
...
<Card title="Street Normalization" href="https://java.documentationai.com/v4/recipes/street-normalization" />
...
As an alternative or used for testing purposes you can set your num_records to 0 in your property search query. This is will only return the num_found of the query and will cost 0 credits to search. Try it out
...
```text
POST https://api.documentationai.com/v4/properties/paginate?page=1&limit=500
{
  "query": "keys:*"
}
```
