...
We will use the [https://api.documentationai.com/v4/views](https://api.documentationai.com/v4/views) API endpoint to create this view. We will use the following top level people fields to create a view that only provides these fields upon an API search/enrichment/suppression request.
...
You can also visit the API reference page [here ](https://developer.documentationai.com/reference/people-data)to test your new view or you can download the postman suite [here](https://developer.documentationai.com/docs/people-data-with-postman-json).
