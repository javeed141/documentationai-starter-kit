...
```curl
curl --request POST --url https://api.documentationai.com/v4/businesses/search --header 'authorization: Bearer AAAXXXXXXXXXXXX' --data '{"query":"categories:hotel","format:json","num_records":1}'
```
...
```curl
curl --request POST --url https://api.documentationai.com/v4/businesses/search --header 'authorization: Bearer AAAXXXXXXXXXXXX' --data '{"query":"categories:hotel AND country:US","format:csv", "num_records": 10}'
```
...
```curl
curl --request POST --url https://api.documentationai.com/v4/businesses/search --header 'authorization: Bearer AAAXXXXXXXXXXXX' --data '{"query":"categories:hotel AND country:US","format:csv","view": "business_basic", "download": true}'
```
