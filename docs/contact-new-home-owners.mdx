...
Learn more about using Autotrace to connect property and people data.
...
<Callout kind="info">
  ...
  **Autotrace people data**
  ...
  For more information on our auto_trace feature, you can read more about it here: [Autotrace](https://java.documentationai.com/docs/autotrace)
...
<Callout kind="info">
  ...
  **Comparing buyer data to Datafiniti's people data**
  ...
  Please visit our documentation on [gathering people contact information](https://java.documentationai.com/docs/gather-people-contact-information) to learn how to query people data. This will allow you to gather phones, emails, and other contact information for reaching out to new home buyers.
