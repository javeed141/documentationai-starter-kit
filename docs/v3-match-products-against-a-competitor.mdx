...
You can also use Datafiniti's Enrichment API to pass in an entire file to enrich.  For more information on how to do this, refer to the [Enrichment API documentation](https://developer.documentationai.com/docs/property-data-with-postman-and-json).
