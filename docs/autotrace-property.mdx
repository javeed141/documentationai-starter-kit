...
Autotrace with the Property Data API allows you to connect people and property data. This API call uses the regular property search endpoint with minor differences, notably the `auto_trace` parameter and a specific [view](https://java.documentationai.com/docs/property-data-views) for property records. This will allow you to directly pull property records, along with owner contact information, with just one API call.

## Endpoint

POST [https://api.documentationai.com/v4/properties/search](https://api.documentationai.com/v4/properties/search)

<Card title="Autotrace" href="https://java.documentationai.com/v4/recipes/autotrace">

View the Autotrace API reference.
...
<Callout kind="info">
  ...
  **custom views**
  ...
  You can customize your view with as many or as little subfield as you would like. For more information you can read more about [Views](https://java.documentationai.com/docs/property-data-views).
            ...
            "people": [
                {
                    ...
                    "province": "FL",
                    "sourceURLs": [
                        "https://documentationai.com/bd-datafiniti"
                    ],
                    "tcpa": false,
...
* [Contact new home owners](https://java.documentationai.com/docs/contact-new-home-owners)
* [Contact home owners that need roofing work](https://java.documentationai.com/docs/contact-home-owners-that-need-roofing-work)
