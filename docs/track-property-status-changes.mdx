...
Please note that Datafiniti tracks for sale and rental statuses separately, so if you are looking for rental statuses please use mostRecentRentalStatus. Being to check the possible status value here. [Possible Values for Property Fields](https://java.documentationai.com/docs/possible-values-for-property-fields)
</Callout>
...
Please note there are many statuses in regards to a non-rental property. You can see our full list of statuses [Possible Values for Property Fields](https://java.documentationai.com/docs/possible-values-for-property-fields)
