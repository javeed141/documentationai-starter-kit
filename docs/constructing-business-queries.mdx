...
You can do similar queries on any of the fields in the [business schema](https://java.documentationai.com/docs/business-data-schema).  Here's an example that queries the `name` field:
