...
<Callout kind="alert">
  ...
  **JSON format**
  ...
  Our enrichment search API will not allow any JSON object with keys that do not match your field parameters. Be sure to match the field parameter in our property schema [here](https://developer.datafiniti.co/docs/property-data-schema). A common error you may see in this case:
