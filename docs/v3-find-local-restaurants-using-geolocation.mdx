...
If you're looking to discover restaurants near a specific location, Datafiniti's Business Data API makes it easy with the `geoLocation` field. This guide will walk you through how to structure your queries to find restaurants within a geographic area, and how to refine your results using other helpful fields in the [business data schema](https://java.documentationai.com/docs/business-data-schema).

<Callout kind="info">
  **What is geoLocation?**

The geoLocation field allows you to search for businesses within a defined radius of a geographic coordinate. This is especially useful when you're looking for local businesses—like restaurants—near a specific city, address, or GPS coordinate. You can visit here for more information on [Geolocation](https://java.documentationai.com/docs/business-geolocation).
</Callout>
